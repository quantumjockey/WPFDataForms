...
{
    /// <summary>
    /// Unit tests addressing functionality within the "WPFDataForms.ViewModel.Forms.ScientificDataFormViewModel" class.
    /// </summary>
    /// <remarks>
    ...
    public partial class ScientificDataFormViewModelTest
    {
        ...
        class ExtraTestFormField : FormFieldScientificDataViewModel
        {
            // empty constructor so class inherits values from base constructor
